@{
	...
	Enable = {
		...
		Export-Command "biodiff" "./.pog/biodiff.cmd" -NoSymlink
		Export-Command "git-biodiff" "./.pog/git-biodiff.cmd" -NoSymlink # git-biodiff.exe depends on finding biodiff.exe
	}
}
